...
export const metadata: Metadata = {
  ...
  description:
    "Nineteen cinematic Otamatsuri cosplay photos shot in Nairobi, Kenya by Nataka Inc. Kenyan cosplayers, handmade armour and props, and the story behind every single frame.",
  keywords: [
    "Otamatsuri cosplay",
  ...
  openGraph: {
    ...
    description:
      "Nineteen cinematic frames of Otamatsuri cosplay, shot in Nairobi with Kenyan cosplayers. Read it like a scroll.",
    url: pageUrl,
    type: "article",
  ...
  twitter: {
    ...
    title: "Otamatsuri Cosplay in Nairobi | Nataka Inc",
    description:
      "Nineteen cinematic frames of Otamatsuri cosplay, shot in Nairobi with Kenyan cosplayers.",
...
const faqs = [
  {
    ...
    a: "Right here. This page holds the full set of cosplay frames from the Otamatsuri promo film, which Nataka Inc directed and produced in and around Nairobi. Otamatsuri itself is Kenya's anime and manga festival, organised by Movie Jabber, and the 2026 edition runs on Saturday 22 August 2026 at The Carnivore Grounds in Nairobi.",
  },
  {
    q: "Were these photos taken at the Otamatsuri convention?",
    a: "No, and it matters. These are frames from the promo film, shot on location around Nairobi with Kenyan cosplayers rather than on a convention floor. That is why the light, the framing and the depth of field look like a film instead of a crowd photo.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes, for personal use. Repost them anywhere you like, just keep the credit to Nataka Inc on them. Six frames from the same shoot are also cut to 1080 by 1920 as free phone wallpapers on the community page.",
  },
  {
...
const gallerySchema = {
  ...
  description:
    "Nineteen cinematic frames of Otamatsuri cosplay, shot on location in and around Nairobi, Kenya with Kenyan cosplayers for the Otamatsuri promo film.",
  url: pageUrl,
  inLanguage: "en-KE",
          ...
          <section className="relative min-h-[74vh] md:min-h-[82vh] flex items-end overflow-hidden">
            ...
            <div className="relative w-full px-6 md:px-14 max-w-7xl mx-auto pb-14 md:pb-20">
              ...
              <p className="font-sans text-white/75 text-sm md:text-base leading-relaxed max-w-2xl">
                Nineteen frames of Otamatsuri cosplay, shot in and around Nairobi by
                Nataka Inc for the Otamatsuri film. Kenyan cosplayers, armour and blades
                built by hand, real Kenyan locations, no convention floor lighting.
            ...
            <div className="grid md:grid-cols-[auto_1fr] gap-6 md:gap-10">
              ...
              <div>
                ...
                <h2 className="font-geist font-black text-white uppercase text-[clamp(1.3rem,4vw,2.6rem)] leading-none mb-5">
                  Kenya has a cosplay scene.
                  <br />
                  <span className="text-shu-light">It just never gets shot properly.</span>
                </h2>
                ...
                <div className="grid md:grid-cols-2 gap-6 md:gap-10 max-w-4xl">
                  <p className="font-sans text-white/70 text-sm md:text-[15px] leading-relaxed">
                    Cosplay in Nairobi normally lives in phone photos taken in a crowded
                    hall, under whatever light the venue happens to have. Months of
                    building, sanding and painting a costume, and the record of it is a
                    blurry vertical clip. That is the gap this shoot went after.
                  </p>
                  <p className="font-sans text-white/70 text-sm md:text-[15px] leading-relaxed">
                    ...
                    cinema glass. These nineteen frames are what came back.
                  </p>
                </div>

                <div className="flex flex-wrap gap-x-8 gap-y-3 mt-8 pt-6 border-t border-white/10">
                  {[
                    { jp: "十九", label: "Frames in the scroll" },
